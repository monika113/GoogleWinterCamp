...
def get_data_loaders(args, tokenizer):
    ...
    personachat = get_dataset_new(tokenizer, args.dataset_path, args.dataset_cache)
...
def train():
    ...
    parser.add_argument("--dataset_path", type=str, default="../data/Homer_gpt22", help="Path or url of the dataset. If empty download from S3.")
